...
class Sessions
{
  public:
    struct Cols
    {
        ...
        static const std::string _last_access;
    };
    ...
    /**  For column device  */
    ///Get the value of the column device, returns the default value if the column is null
    const std::string &getValueOfDevice() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getDevice() const noexcept;
    ///Set the value of the column device
    void setDevice(const std::string &pDevice) noexcept;
    void setDevice(std::string &&pDevice) noexcept;

    /**  For column last_access  */
    ///Get the value of the column last_access, returns the default value if the column is null
    const std::string &getValueOfLastAccess() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getLastAccess() const noexcept;
    ///Set the value of the column last_access
    void setLastAccess(const std::string &pLastAccess) noexcept;
    void setLastAccess(std::string &&pLastAccess) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> device_;
    std::shared_ptr<std::string> lastAccess_;
    struct MetaData
    {
