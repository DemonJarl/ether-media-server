...
class Images
{
  public:
    ...
    /**  For column image_type_id  */
    ///Get the value of the column image_type_id, returns the default value if the column is null
    const int64_t &getValueOfImageTypeId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getImageTypeId() const noexcept;
    ///Set the value of the column image_type_id
    void setImageTypeId(const int64_t &pImageTypeId) noexcept;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Images, true, false>;
    friend drogon::orm::BaseBuilder<Images, false, true>;
    friend drogon::orm::BaseBuilder<Images, false, false>;
#ifdef __cpp_impl_coroutine
