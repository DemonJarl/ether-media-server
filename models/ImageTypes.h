...
class ImageTypes
{
  public:
     ...
     */
    explicit ImageTypes(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ImageTypes(const Json::Value &pJson) noexcept(false);
     ...
     */
    ImageTypes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<ImageTypes>;
    friend drogon::orm::BaseBuilder<ImageTypes, true, true>;
    friend drogon::orm::BaseBuilder<ImageTypes, true, false>;
    friend drogon::orm::BaseBuilder<ImageTypes, false, true>;
    friend drogon::orm::BaseBuilder<ImageTypes, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ImageTypes>;
#endif
