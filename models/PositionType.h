...
class PositionType
{
  public:
     ...
     */
    explicit PositionType(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PositionType(const Json::Value &pJson) noexcept(false);
     ...
     */
    PositionType(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<PositionType>;
    friend drogon::orm::BaseBuilder<PositionType, true, true>;
    friend drogon::orm::BaseBuilder<PositionType, true, false>;
    friend drogon::orm::BaseBuilder<PositionType, false, true>;
    friend drogon::orm::BaseBuilder<PositionType, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<PositionType>;
#endif
