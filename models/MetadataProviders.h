...
class MetadataProviders
{
  public:
     ...
     */
    explicit MetadataProviders(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit MetadataProviders(const Json::Value &pJson) noexcept(false);
     ...
     */
    MetadataProviders(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    MetadataProviders() = default;
  ...
  private:
    friend drogon::orm::Mapper<MetadataProviders>;
    friend drogon::orm::BaseBuilder<MetadataProviders, true, true>;
    friend drogon::orm::BaseBuilder<MetadataProviders, true, false>;
    friend drogon::orm::BaseBuilder<MetadataProviders, false, true>;
    friend drogon::orm::BaseBuilder<MetadataProviders, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<MetadataProviders>;
#endif
