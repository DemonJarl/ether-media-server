...
class CreditTypes
{
  public:
     ...
     */
    explicit CreditTypes(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CreditTypes(const Json::Value &pJson) noexcept(false);
     ...
     */
    CreditTypes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<CreditTypes>;
    friend drogon::orm::BaseBuilder<CreditTypes, true, true>;
    friend drogon::orm::BaseBuilder<CreditTypes, true, false>;
    friend drogon::orm::BaseBuilder<CreditTypes, false, true>;
    friend drogon::orm::BaseBuilder<CreditTypes, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<CreditTypes>;
#endif
