...
class Libraries
{
  public:
     ...
     */
    explicit Libraries(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Libraries(const Json::Value &pJson) noexcept(false);
     ...
     */
    Libraries(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    std::vector<LibraryPaths> getLibraryPaths(const drogon::orm::DbClientPtr &clientPtr) const;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Libraries, true, false>;
    friend drogon::orm::BaseBuilder<Libraries, false, true>;
    friend drogon::orm::BaseBuilder<Libraries, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Libraries>;
#endif
