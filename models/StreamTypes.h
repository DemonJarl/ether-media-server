...
class StreamTypes
{
  public:
     ...
     */
    explicit StreamTypes(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit StreamTypes(const Json::Value &pJson) noexcept(false);
     ...
     */
    StreamTypes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<StreamTypes>;
    friend drogon::orm::BaseBuilder<StreamTypes, true, true>;
    friend drogon::orm::BaseBuilder<StreamTypes, true, false>;
    friend drogon::orm::BaseBuilder<StreamTypes, false, true>;
    friend drogon::orm::BaseBuilder<StreamTypes, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<StreamTypes>;
#endif
