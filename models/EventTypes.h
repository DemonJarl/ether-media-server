...
class EventTypes
{
  public:
     ...
     */
    explicit EventTypes(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit EventTypes(const Json::Value &pJson) noexcept(false);
     ...
     */
    EventTypes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<EventTypes>;
    friend drogon::orm::BaseBuilder<EventTypes, true, true>;
    friend drogon::orm::BaseBuilder<EventTypes, true, false>;
    friend drogon::orm::BaseBuilder<EventTypes, false, true>;
    friend drogon::orm::BaseBuilder<EventTypes, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<EventTypes>;
#endif
