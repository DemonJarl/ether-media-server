...
class Genres
{
  public:
     ...
     */
    explicit Genres(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Genres(const Json::Value &pJson) noexcept(false);
     ...
     */
    Genres(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Genres>;
    friend drogon::orm::BaseBuilder<Genres, true, true>;
    friend drogon::orm::BaseBuilder<Genres, true, false>;
    friend drogon::orm::BaseBuilder<Genres, false, true>;
    friend drogon::orm::BaseBuilder<Genres, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Genres>;
#endif
