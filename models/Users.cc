...
const std::string Users::Cols::_administrator = "administrator";
const std::string Users::Cols::_settings = "settings";
...
{"administrator","int64_t","integer",8,0,0,1},
...
Users::Users(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        ...
        if(!r["administrator"].isNull())
        {
            administrator_=std::make_shared<int64_t>(r["administrator"].as<int64_t>());
        }
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            administrator_=std::make_shared<int64_t>(r[index].as<int64_t>());
        }
        index = offset + 4;
        if(!r[index].isNull())
        {
...
Users::Users(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[3].empty() && pJson.isMember(pMasqueradingVector[3]))
    {
        ...
        {
            administrator_=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[3]].asInt64());
        }
    }
    if(!pMasqueradingVector[4].empty() && pJson.isMember(pMasqueradingVector[4]))
    {
        ...
        {
            settings_=std::make_shared<std::string>(pJson[pMasqueradingVector[4]].asString());
        }
    }
}
...
Users::Users(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("administrator"))
    {
        dirtyFlag_[3]=true;
        if(!pJson["administrator"].isNull())
        {
            administrator_=std::make_shared<int64_t>((int64_t)pJson["administrator"].asInt64());
        }
    }
...
const int64_t &Users::getValueOfAdministrator() const noexcept
{
    static const int64_t defaultValue = int64_t();
    if(administrator_)
...
const std::shared_ptr<int64_t> &Users::getAdministrator() const noexcept
{
    return administrator_;
}
void Users::setAdministrator(const int64_t &pAdministrator) noexcept
{
    administrator_ = std::make_shared<int64_t>(pAdministrator);
    dirtyFlag_[3] = true;
}

const std::string &Users::getValueOfSettings() const noexcept
{
    static const std::string defaultValue = std::string();
    if(settings_)
        return *settings_;
...
const std::shared_ptr<std::string> &Users::getSettings() const noexcept
{
    return settings_;
}
void Users::setSettings(const std::string &pSettings) noexcept
{
    settings_ = std::make_shared<std::string>(pSettings);
    dirtyFlag_[4] = true;
}
void Users::setSettings(std::string &&pSettings) noexcept
{
...
void Users::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    ...
    if(dirtyFlag_[3])
    {
        if(getAdministrator())
        {
            binder << getValueOfAdministrator();
        }
        else
        {
            binder << nullptr;
...
Json::Value Users::toJson() const
{
    ...
    if(getAdministrator())
    {
        ret["administrator"]=(Json::Int64)getValueOfAdministrator();
    }
    else
    {
        ret["administrator"]=Json::Value();
    }
    if(getSettings())
    {
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 5)
    {
        ...
        if(!pMasqueradingVector[3].empty())
        {
            if(getAdministrator())
            {
                ret[pMasqueradingVector[3]]=(Json::Int64)getValueOfAdministrator();
            }
            else
            {
        ...
        if(!pMasqueradingVector[4].empty())
        {
            if(getSettings())
            {
                ret[pMasqueradingVector[4]]=getValueOfSettings();
            }
            else
            {
...
bool Users::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("administrator"))
    {
        if(!validJsonOfField(3, "administrator", pJson["administrator"], err, true))
            return false;
    }
    else
    {
        err="The administrator column cannot be null";
        return false;
    }
    if(pJson.isMember("settings"))
    {
        if(!validJsonOfField(4, "settings", pJson["settings"], err, true))
            return false;
    }
    else
    {
...
bool Users::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("administrator"))
    {
        if(!validJsonOfField(3, "administrator", pJson["administrator"], err, false))
            return false;
    }
    if(pJson.isMember("settings"))
    {
        if(!validJsonOfField(4, "settings", pJson["settings"], err, false))
            return false;
    }
    return true;
}
